...
VALUES ('2020-12-12' ,'Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday',1,109.5,'3','APPROVED','Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops',2,'https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg');

INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)

    VALUES ('2020-12-12' ,'Slim-fitting style, contrast raglan long sleeve, three-button henley placket, light weight & soft fabric for breathable and comfortable wearing.',1,120.5,'3','APPROVED','Mens Casual Premium Slim Fit T-Shirts',2,'https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg');


INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)

    VALUES ('2020-12-12' ,'great outerwear jackets for Spring/Autumn/Winter, suitable for many occasions, such as working, hiking, camping, mountain/rock climbing, cycling, traveling or other outdoors. Good gift choice for you or your family member.",
...
/*INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)
    ...
    VALUES ('2020-12-12' ,'From our Legends Collection, the Naga was inspired by the mythical water dragon that protects the ocean''s pearl. Wear facing inward to be bestowed with love and abundance, or outward for protection.',1,109.5,'3','APPROVED','John Hardy Women''s Legends Naga Gold & Silver Dragon Station Chain Bracelet',1,'https://fakestoreapi.com/img/71pWzhdJNwL._AC_UL640_QL65_ML3_.jpg');
*/


/*INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)

    VALUES ('2020-12-12' ,'Satisfaction Guaranteed. Return or exchange any order within 30 days.Designed and sold by Hafeez Center in the United States.',1,120.5,'3','APPROVED','Solid Gold Petite Micropave',1,'https://fakestoreapi.com/img/61sbMiUnoGL._AC_UL640_QL65_ML3_.jpg');
*/

/*INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)

    VALUES ('2020-12-12' ,'Classic Created Wedding Engagement Solitaire Diamond Promise Ring for Her. ',1,134.5,'3','APPROVED','White Gold Plated Princess',1,'https://fakestoreapi.com/img/71YAIFU48IL._AC_UL640_QL65_ML3_.jpg');
*/
/*INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)

    VALUES ('2020-12-12' ,'Rose Gold Plated Double Flared Tunnel Plug Earrings. Made of 316L Stainless Steel',
...
/*INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)
    VALUES ('2020-12-12' ,'USB 3.0 and USB 2.0 Compatibility Fast data transfers Improve PC Performance High Capacity; Compatibility Formatted NTFS for Windows 10',
...
/*
INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)
    VALUES ('2020-12-12' ,'Easy upgrade for faster boot up, shutdown, application load and response (As compared to 5400 RPM SATA 2.5” hard drive;',
...
/*INSERT INTO product(created_on, description, featured, price, rating, status, title, sub_cat_id,image)
    VALUES ('2020-12-12' ,'3D NAND flash are applied to deliver high transfer speeds Remarkable transfer speeds that enable faster bootup and improved overall system performance.',
