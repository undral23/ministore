...
import edu.miu.waa.ministore.dto.OrderDTO;
...
public class BuyerController {
	...
	public void followSeller(@PathVariable String bUserName, @PathVariable String sUserName) {
		buyerService.followSeller(buyerService.getBuyerByUsername(bUserName).getBId(),
				sellerService.getSellerByUserName(sUserName).getId());
	}
	...
	public void unFollowSeller(@PathVariable String bUserName, @PathVariable String sUserName) {
		buyerService.unFollowSeller(buyerService.getBuyerByUsername(bUserName).getBId(),
				sellerService.getSellerByUserName(sUserName).getId());
	}
	...
	public Address editSippingAddress(@PathVariable String seller_UserName, @RequestBody Address address,
			@PathVariable long address_id) {
	...
	public CreditCard editCardAddress(@PathVariable String seller_UserName, @RequestBody CreditCard creditCard,
